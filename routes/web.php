...
Route::prefix('admin')->name('admin.')->middleware('auth')->group(function () {
  ...
  Route::post('asistencias_docentes', [AsistenciaDocenteController::class, 'store'])->name('asistencias_docentes.store');
  Route::get('asistencias_docentes', [AsistenciaDocenteController::class, 'index'])->name('asistencias_docentes.index');
  Route::get('asistencias_docentes/{id}/edit', [AsistenciaDocenteController::class, 'edit'])->name('asistencias_docentes.edit');
  Route::put('asistencias_docentes/{id}', [AsistenciaDocenteController::class, 'update'])->name('asistencias_docentes.update');
  Route::delete('asistencias_docentes/{id}', [AsistenciaDocenteController::class, 'destroy'])->name('asistencias_docentes.destroy');
});
