...
<!-- modernizr css -->
<script src="<?php echo e(asset('backend/assets/js/vendor/modernizr-2.8.3.min.js')); ?>"></script><?php /**PATH D:\codigos\sistema\person\resources\views/backend/layouts/partials/styles.blade.php ENDPATH**/ ?>