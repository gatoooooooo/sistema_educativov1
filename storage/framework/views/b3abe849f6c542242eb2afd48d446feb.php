...
<script src="<?php echo e(asset('backend/assets/js/line-chart.js')); ?>"></script>
<!-- all pie chart -->
<script src="<?php echo e(asset('backend/assets/js/pie-chart.js')); ?>"></script>
<!-- others plugins -->
<script src="<?php echo e(asset('backend/assets/js/plugins.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/scripts.js')); ?>"></script><?php /**PATH D:\codigos\sistema\person\resources\views/backend/layouts/partials/scripts.blade.php ENDPATH**/ ?>